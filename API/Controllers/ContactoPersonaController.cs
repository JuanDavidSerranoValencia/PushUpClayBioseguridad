...
public class ContactoPersonaController: BaseController
    {
        ...
        {
            var entidades = await _unitOfWork.ContactoPersonas.GetAllAsync();
        ...
        {
            var entidad = await _unitOfWork.ContactoPersonas.GetByIdAsync(id);
            if(entidad == null)
            {
                return NotFound();
            }
        ...
        public async Task<ActionResult<ContactoPersona>> Post(ContactoPersonaDto ContactoPersonaDto)
        {
            ...
            this._unitOfWork.ContactoPersonas.Add(entidad);
        ...
        public async Task<ActionResult<ContactoPersonaDto>> Put(int id, [FromBody] ContactoPersonaDto ContactoPersonaDto)
        {
            ...
            _unitOfWork.ContactoPersonas.Update(entidades);
            await _unitOfWork.SaveAsync();
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _unitOfWork.ContactoPersonas.Delete(entidad);
            await _unitOfWork.SaveAsync();
            return NoContent();
        }
    }
